...
original. Вопрос записывается через original цифры и точки между ними, где первая цифра - номер раздела, вторая цифра - номер вопроса в разделе, третья цифра - вид ответов. Пример: 
1.1.original Вопрос 1
1.2.4 Вопрос 2

Виды ответов в номерах:
original -  Хорошие, Удовлетворительные, Неудовлетворительные
